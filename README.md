...
- **ai_agent_refs/**: AI 에이전트 작동 및 프롬프트 최적화를 위한 공통 설계 지침
  ...
  - [Modern_AI_Desktop_UI_Guidelines.md](ai_agent_refs/Modern_AI_Desktop_UI_Guidelines.md): 2025~2026 프로 도구(Pro-Tool) 및 관제(SOC) 대시보드와 AI 추론 스트리밍 UI 디자인 시스템 표준 지침
