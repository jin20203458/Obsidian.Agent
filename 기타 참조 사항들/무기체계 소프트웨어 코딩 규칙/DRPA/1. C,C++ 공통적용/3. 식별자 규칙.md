...
<font color="#00b050">나) external linkage scope에서 선언된 함수나 Object의 이름은 유일해야 한다.</font>

<font color="#00b050">다) external linkage scope에서 정의된 함수나 Object의 데이터형은 선언 시 정의와 동일해야 한다.</font>
