...
* **상세 스펙**: [01_game_server_architecture.md](01_game_server_architecture.md)
  * [3-스레드 Proactor 스레드 모델](01_game_server_architecture.md#1-3-스레드-proactor-모델-thread-model)
  * [ProcessWorldTick 10초 주기 동기화 흐름도](01_game_server_architecture.md#2-틱-동기화-및-관계-델타-데이터-흐름-processworldtick-flow)
  * [대화 주도/수락/다자간 합류 확률 공식 및 트리거 흐름도](01_game_server_architecture.md#3-대화-트리거--다자간-합류-로직-dialogue-trigger-logic)
